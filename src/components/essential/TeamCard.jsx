const TeamMemberCard = ({
  ...
  return (
    <div
      className="relative w-full max-w-90 lg:w-90
      aspect-9/13
    ...
    >
      ...
      <div
        ...
        shadow-[inset_0_0_90px_rgba(60,40,20,0.55)]"
      ></div>

      {/* NAME */}
      <div className="px-5 sm:px-6 pt-6 pb-3 border-b border-[#8d6e63]/60">
        <h1
          className="font-accent text-xl sm:text-2xl uppercase tracking-[0.18em]
      ...
      {isStudent && (
        <div
          className="grid grid-cols-2 text-[10px] sm:text-[11px] uppercase font-bold
      ...
      <div className="bg-[#4a3728] py-4 text-center">
        <p
          className="text-[#f2e6d0] font-accent text-xs sm:text-sm
