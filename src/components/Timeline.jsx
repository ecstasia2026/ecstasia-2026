  ...
  return (
    ...
    >
      <div className="w-full h-full relative flex flex-col lg:block">
        ...
        {/* 1. Header Title */}
        <div className="order-1 mt-31 lg:mt-11 ml-0 md:-ml-7 mr-0 md:mr-5 text-center w-full lg:absolute lg:top-[8%] lg:right-[7%] z-30 lg:text-right lg:w-auto">
          <h1
            // Scaled text: text-5xl (mobile) -> text-7xl (tablet) -> text-9xl (desktop)
            className="text-5xl sm:text-7xl lg:text-8xl leading-none text-[#532301] font-heading drop-shadow-sm"
          >
            Timeline
          </h1>
        </div>
        ...
        <div className="order-3 z-20 flex flex-col items-center gap-4 -mt-6 w-full lg:block lg:absolute lg:top-[42%] lg:left-[8%] lg:gap-0 lg:mt-0 lg:mb-0 lg:w-auto">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full w-full pt-1">
              <span className="text-3xl md:text-5xl lg:text-[3.5rem] leading-tight text-[#550a0a] font-mokgech transition-transform duration-300 ease-out group-hover:-translate-y-2 lg:group-hover:-translate-y-3">
                14th march
              </span>
